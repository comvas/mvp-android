...
//        }
    ...
    private fun setupViewPager(viewPager: ViewPager) {
        ...
        adapter.addFragment(BoardContentsFragment.createInstance("hoge", Color.parseColor("#3F7A63"), projectId, boards?.get(0)!!.boardId), "HI-FIVES")
        adapter.addFragment(BoardContentsFragment.createInstance("hoge", Color.parseColor("#F29089"), projectId, boards?.get(1)!!.boardId), "HI-FIVES")
        adapter.addFragment(BoardContentsFragment.createInstance("hoge", Color.parseColor("#3F7A63"), projectId, boards?.get(2)!!.boardId), "HI-FIVES")
